...
public class ExampleTest {
    ...
    public static void beforeClass() throws Exception {
        ...
        embeddedJetty = new EmbeddedJetty()
                .keyStoreFile("src/test/resources/jetty-localhost.jks")
                .keyStorePass("jetty");
        embeddedJetty.start();
        ...
        ExampleTest.list = rv;
        new GenericRepository(embeddedJetty.getInjector().getInstance(PersistenceManagerFactory.class)).addAll(rv);
    }
