...
public class PersistenceConfiguration {
    ...
    public PersistenceConfiguration createEntityManagerFactory() {
        ...
        if (null != System.getProperty("RDS_USERNAME")) {
            ...
            emf = createFromClassPath("datanucleus.properties");
        }
    ...
    protected PersistenceManagerFactory createFromClassPath(String resource) {
        log.info("loading PersistenceManagerFactory properties from classpath {}", resource);
        return JDOHelper.getPersistenceManagerFactory(resource);
    }
}