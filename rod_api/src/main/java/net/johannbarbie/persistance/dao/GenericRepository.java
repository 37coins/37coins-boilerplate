...
import net.johannbarbie.persistance.TreePersistenceManager;
...
public class GenericRepository {
	...
	public GenericRepository() {
		pmf = TreePersistenceManager.getInstance().getEntityManagerFactory();
	}
...
//		}
	...
	public <K extends Model> Model findById(Long id, Class<K> entityClass)
			throws EntityNotFoundException, ParameterMissingException {
		if (null == pm || pm.isClosed()) {
			pm = pmf.getPersistenceManager();
		}
